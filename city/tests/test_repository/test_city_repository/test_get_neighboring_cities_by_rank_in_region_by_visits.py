...
def test_neighboring_cities_by_visits_returns_correct_list_with_region(mocker, repo):
    """
    ...
    result = repo.get_neighboring_cities_by_rank_in_region_by_visits(42)
...
def test_neighboring_cities_by_visits_returns_correct_list_without_region(mocker, repo):
    """
...
def test_neighboring_cities_by_visits_city_does_not_exist(mocker, repo):
    """
    ...
    result = repo.get_neighboring_cities_by_rank_in_region_by_visits(123)
    assert result == []

def test_neighboring_cities_by_visits_multiple_objects_returned(mocker, repo):
    """
...
def test_neighboring_cities_by_visits_empty_ranked_list(mocker, repo):
    """
...
def test_neighboring_cities_by_visits_orm_methods_called(mocker, repo):
    """
    ...
    repo.get_neighboring_cities_by_rank_in_region_by_visits(42)
