...
class VisitedCity(models.Model):
    ...
    impression = models.TextField(
        ...
        blank=True,
        null=True,
        help_text='В этом поле Вы можете использовать некоторые элементы разметки Markdown, для того, чтобы стилизовать текст. Доступные элементы: заголовки, жирный и курсивный шрифты, ссылки, нумерованные и ненумерованные списки, разделительная линия.',
    )
