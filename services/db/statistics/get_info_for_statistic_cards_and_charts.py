...
def get_info_for_statistic_cards_and_charts(user_id: int) -> dict:
    ...
    all_countries_with_visited_cities = get_countries_with_visited_city(user_id)
    # Страны с посещёнными городами (включая повторные посещения) в текущем году
    countries_with_visited_cities_current_year = get_countries_with_visited_city_in_year(
        user_id, current_year
    )
    # Страны с новыми посещёнными городами в текущем году
    countries_with_new_visited_cities_current_year = get_countries_with_new_visited_city_in_year(
        user_id, current_year
    )
    # Страны с посещёнными городами (включая повторные посещения) в прошлом году
    countries_with_visited_cities_previous_year = get_countries_with_visited_city_in_year(
        user_id, current_year - 1
    )
    # Страны с новыми посещёнными городами в прошлом году
    countries_with_new_visited_cities_previous_year = get_countries_with_new_visited_city_in_year(
        user_id, current_year - 1
    )
    ...
    context['cities'] = {
        ...
        'all_countries_with_visited_cities': all_countries_with_visited_cities,
        'countries_with_visited_cities_current_year': countries_with_visited_cities_current_year,
        'countries_with_new_visited_cities_current_year': countries_with_new_visited_cities_current_year,
        'countries_with_visited_cities_previous_year': countries_with_visited_cities_previous_year,
        'countries_with_new_visited_cities_previous_year': countries_with_new_visited_cities_previous_year,
