...
def test_get_subscribed_users_empty_list(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscribed_users_single_subscription(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscribed_users_multiple_subscriptions(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscribed_users_only_own_subscriptions(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_empty_list(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_single_subscriber(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_with_share_settings_true(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_with_share_settings_false(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_multiple_subscribers(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_only_own_subscribers(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_get_subscriber_users_with_deleted_share_settings(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_subscriptions_are_bidirectional_independent(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_mutual_subscriptions(create_users):
...
@pytest.mark.integration
@pytest.mark.django_db
def test_repository_functions_with_nonexistent_user():
...
@pytest.mark.integration
@pytest.mark.django_db
def test_share_settings_update_reflects_in_subscribers(create_users):
