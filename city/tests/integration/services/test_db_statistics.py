...
class TestNumberOfCitiesFunctions:
    ...
    def test_get_number_of_cities_in_region_by_city(self, setup_cities: dict[str, Any]) -> None:
        """Подсчёт городов в регионе по ID города."""
        moscow = setup_cities['moscow']
        _kazan = setup_cities['kazan']  # В том же регионе
...
class TestVisitedCitiesCountFunctions:
    ...
    def test_get_number_of_new_visited_cities_no_visits(self, setup_cities: dict[str, Any]) -> None:
    ...
    def test_get_number_of_new_visited_cities_with_visits(
        ...
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2024, 1, 1), rating=5, is_first_visit=True
        )
        VisitedCity.objects.create(
            user=user1, city=spb, date_of_visit=date(2024, 2, 1), rating=4, is_first_visit=True
        )
        # Повторное посещение Москвы
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2024, 3, 1), rating=5, is_first_visit=False
        )
    ...
    def test_get_number_of_new_visited_cities_by_country(
        ...
        VisitedCity.objects.create(user=user1, city=moscow, rating=5, is_first_visit=True)
        VisitedCity.objects.create(user=user1, city=almaty, rating=4, is_first_visit=True)
    ...
    def test_get_number_of_visited_cities_with_repeats(self, setup_cities: dict[str, Any]) -> None:
        ...
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2024, 2, 1), rating=4, is_first_visit=False
        )
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2024, 3, 1), rating=5, is_first_visit=False
        )
...
class TestYearlyStatisticsFunctions:
    ...
    def test_get_number_of_total_visited_cities_by_year(self, setup_cities: dict[str, Any]) -> None:
        ...
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2023, 1, 1), rating=5, is_first_visit=True
        )
        VisitedCity.objects.create(
            user=user1, city=moscow, date_of_visit=date(2023, 6, 1), rating=4, is_first_visit=False
        )
        VisitedCity.objects.create(
            user=user1, city=spb, date_of_visit=date(2023, 12, 1), rating=5, is_first_visit=True
        )
        VisitedCity.objects.create(
    ...
    def test_get_number_of_new_visited_cities_by_year(self, setup_cities: dict[str, Any]) -> None:
...
class TestUserVisitStatistics:
    ...
    def test_get_number_of_users_who_visit_city(self, setup_cities: dict[str, Any]) -> None:
        ...
        VisitedCity.objects.create(user=user1, city=moscow, rating=5, is_first_visit=True)
        VisitedCity.objects.create(user=user2, city=moscow, rating=4, is_first_visit=True)
        # Повторное посещение не должно учитываться
        VisitedCity.objects.create(user=user1, city=moscow, rating=5, is_first_visit=False)
...
class TestNeighboringCitiesFunctions:
    ...
    def test_get_neighboring_cities_by_visits_rank(self, setup_cities: dict[str, Any]) -> None:
