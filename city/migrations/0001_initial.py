        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text='Укажите дату посещения города. На основе этой даты будет происходить сортировка городов, а также это влияет на отображаемую статистику посещённых городов за год.',
                        null=True,
                ...
                (
                    'region',
                    models.ForeignKey(
                        help_text='Выберите регион, в котором находится посещённый город. Список городов выбранного региона подгрузится автоматически в поле "Город".',
                        on_delete=django.db.models.deletion.CASCADE,
                        to='region.region',
                        verbose_name='Регион',
                    ),
