...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(
        ...
        help_text='Проверьте правильность указанного email. На него придёт письмо с подтверждением регистрации. '
                  'Также этот адрес будет использован для восстановления пароля, если Вы его забудете.',
        required=True)
